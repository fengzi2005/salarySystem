...
const annualYear = ref<any>(now.getFullYear())
...
function renderStatsChart() {
  ...
  chart2.setOption({
    ...
    series: [{
      type: 'pie', radius: ['45%', '75%'], center: ['35%', '50%'],
      data: statsData.value.map((d: any) => ({ name: d.dept_name, value: Number(d.total_salary) })),
      label: { formatter: '{b}\n{d}%' }
    }]
  })
}
  ...
  <div class="page-container">
    <el-tabs v-model="activeTab" type="card" @tab-change="onTabChange">
      ...
      <el-tab-pane label="薪资结构分析" name="structure">
        <div class="toolbar">
          <el-date-picker v-model="reportMonth" type="month" format="YYYY年M月" value-format="YYYY-MM" style="width: 150px" />
          <el-button type="primary" :icon="Search" @click="loadStructure" style="margin-left: 8px">查询</el-button>
        </div>
        ...
        <div id="chart-structure" style="height: 350px; margin-top: 12px;"></div>
      </el-tab-pane>
      ...
      <el-tab-pane label="部门薪资统计" name="stats">
        ...
        <div id="chart-stats" style="height: 350px; margin-top: 12px;"></div>
      </el-tab-pane>
      ...
      <el-tab-pane label="员工年度统计" name="annual">
        <div class="toolbar">
          ...
          <el-date-picker v-model="annualYear" type="year" format="YYYY年" value-format="YYYY" placeholder="选择年份" style="width: 130px; margin-left: 8px" />
        ...
        <div id="chart-annual" style="height: 350px; margin-top: 12px;"></div>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
